...
class Terminal(models.Model):
    ...
    platform_type = models.CharField(max_length=3, choices=TradingAccount.PLATFORM_CHOICES)
...
class Trade(models.Model):
    ...
    price_close = models.DecimalField(max_digits=15, decimal_places=5, null=True, blank=True)
